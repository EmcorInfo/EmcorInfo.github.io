...
function Hemopage() {
  return (
    ...
    <Container className="p-2 my-3 align-items-center justify-content-center d-flex flex-column">
      ...
      <a href="https://api.whatsapp.com/send?phone=5521974087703&text=Olá! Gostaria de falar sobre Hemodinâmica." rel='noreferrer' target="_blank" className="WhatsappButton my-2"> </a>
    </Container>    
    <Breadcrumb crumb2="Serviços" href="/2" crumb="Hemodinâmica"/>
    <Footer2/>
    </>
  )
}
