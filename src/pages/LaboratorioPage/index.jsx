...
function LabPage() {
  return (
    ...
    <Container className="p-2 my-3 align-items-center justify-content-center d-flex flex-column">
      ...
      <a href="https://api.whatsapp.com/send?phone=5521986436540&text=Olá! Gostaria de saber sobre Exames de laboratório." rel='noreferrer' target="_blank" className="WhatsappButton my-2"> </a>
    </Container>    
    <Breadcrumb crumb2="Serviços" href="/servic/" crumb="Laboratório"/>
    <Footer2/>
    </>
  )
}
